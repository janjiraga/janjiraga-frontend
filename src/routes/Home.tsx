  ...
  return (
    <>
      ...
      <div className="flex mb-4 p-4">
        ...
        <div className="w-1/2 ">
          <h1 className=" font-extrabold text-2xl"> Temukan kawan mainmu sekarang!</h1>
          <p className=" m-2">Banyak kawan sudah menantimu di gelanggang, yuk gabung Janjiraga sekarang juga!</p>
